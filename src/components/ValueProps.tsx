...
const features = [
  ...
  },
  {
    ...
    description: "Agrega tu catálogo personalizado para visibilizar tus productos y servicios",
  },
];

const ValueProps = () => {
  return (
    <section id="servicios" className="py-20 px-4 relative scroll-mt-[var(--header-h)]">
